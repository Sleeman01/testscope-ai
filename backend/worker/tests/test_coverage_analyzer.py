...
from worker_app.nodes.coverage_analyzer import CoverageEntry, coverage_analyzer
...
async def test_classifies_each_criterion():
    ...
    with patch("worker_app.nodes.coverage_analyzer.call_llm", new=AsyncMock(return_value=stub)):
