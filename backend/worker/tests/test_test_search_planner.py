...
from worker_app.nodes.test_search_planner import SearchKeywords, test_search_planner
...
async def test_generates_keywords_from_criteria():
    ...
    with patch("worker_app.nodes.test_search_planner.call_llm", new=AsyncMock(return_value=stub)):
